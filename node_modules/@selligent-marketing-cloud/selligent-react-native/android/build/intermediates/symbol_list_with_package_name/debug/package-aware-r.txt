...
bool enable_gcm_scheduler_default
...
drawable sm_ic_action_camera
drawable sm_ic_action_gallery
drawable sm_ic_action_navigation_back
drawable sm_ic_action_navigation_forward
drawable sm_ic_action_validation
drawable sm_ic_close_image
drawable sm_ic_pause
drawable sm_ic_play
drawable sm_ic_stop
...
id size_layout
id slide
id sm_action_navigation_back
id sm_action_navigation_forward
id sm_action_url_navigation_group
id sm_close_button
id sm_dialog_button_container
id sm_dialog_message
id sm_dialog_title
id sm_dialog_upper_divider
id sm_huaweiMapView_container
id sm_iac_html_body
id sm_iac_html_button_container
id sm_iac_html_first_button
id sm_iac_html_lower_separation
id sm_iac_html_second_button
id sm_iac_html_title
id sm_iac_html_upper_separation
id sm_inappcontent_image_view
id sm_inappcontent_recycler_view
id sm_inappcontent_web_view
id sm_mapView_container
id sm_no_permission
...
id takePictureFromCamera
id takePictureFromGallery
id terrain
...
integer sm_error_resolution_request_google_api_connection
integer sm_permission_request_coarse_location
integer sm_permission_request_fine_location
integer sm_permission_request_location
integer sm_permission_request_write_external_storage
...
layout activity_huawei_map
layout activity_map
layout activity_map_old
layout activity_notification
layout activity_response_old
layout activity_sell_base
layout activity_view
...
layout empty_layout
layout fps_view
layout fragment_sm_inappcontent_recycler_view
...
layout plot_console_activity
layout plot_console_fragment
...
string plot_title_console_activity
...
string sm_permission_explanation_location
string sm_permission_explanation_write_external_storage
string sm_permissions_not_enough
...
string title_activity_notification
string title_activity_response
string title_activity_sell_base
string title_activity_view
...
style SMDialog
style SMFullScreenDialog
style Selligent
style Selligent_Dialog
style Selligent_Dialog_Body
style Selligent_Dialog_BodyScrollView
style Selligent_Dialog_Button
style Selligent_Dialog_ButtonContainer
style Selligent_Dialog_ButtonRow
style Selligent_Dialog_ButtonScrollView
style Selligent_Dialog_Container
style Selligent_Dialog_LowerDivider
style Selligent_Dialog_Title
style Selligent_Dialog_UpperDivider
style Selligent_InAppContents
style Selligent_InAppContents_CloseButton
style Selligent_InAppContents_Html
style Selligent_InAppContents_Html_Card
style Selligent_InAppContents_Html_CardBody
style Selligent_InAppContents_Html_CardContainer
style Selligent_InAppContents_Html_CardLink
style Selligent_InAppContents_Html_CardLinkContainer
style Selligent_InAppContents_Html_CardTitle
style Selligent_InAppContents_Html_Container
style Selligent_InAppContents_Html_LowerDivider
style Selligent_InAppContents_Html_UpperDivider
style Selligent_InAppContents_Image
...
styleable MapAttrs ambientEnabled cameraBearing cameraMaxZoomPreference cameraMinZoomPreference cameraTargetLat cameraTargetLng cameraTilt cameraZoom latLngBoundsNorthEastLatitude latLngBoundsNorthEastLongitude latLngBoundsSouthWestLatitude latLngBoundsSouthWestLongitude liteMode mapType previewId styleId supportChina uiCompass uiMapToolbar uiRotateGestures uiScrollGestures uiScrollGesturesDuringRotateOrZoom uiTiltGestures uiZoomControls uiZoomGestures useViewLifecycle zOrderOnTop
